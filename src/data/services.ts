...
export const services: Service[] = [
  ...
  },
  {
    ...
    icon: '04',
    tagline: 'High-performance digital infrastructure and growth systems.',
    description:
      'ADin provides comprehensive digital services — from performance-led websites and content systems to integrated analytics and marketing automation — engineered to scale brand impact.',
    features: [
